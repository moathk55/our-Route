...
class CampusMap:
    def __init__(self):
        self.graph = Graph(json.loads(open('The-Campus.json').read()))
...
class FindRoute:
    ...
    def __init__(self):
        ...
        self.start_place = self.campusMap.set_starting_place()
        self.target_place = self.campusMap.set_target_place()
    ...
    def depth_first_search(self):
        ...
        while not self.stack.is_empty():
            ...
            if current_place == self.target_place:
                ...
                connected_nodes = self.campusMap.graph.get_children_of_node(
                    current_place)
    ...
    def greedy_first_search(self):
        ...
        while current_place is not self.target_place:
            ...
            for place in queue:
                ...
                connected_nodes_to_first = sorted(self.campusMap.graph.get_children_of_node(first_in_queue), key=lambda i: i['distance'])
